      ...
      body: SingleChildScrollView(
        child: Expanded(
          ...
          child: SizedBox(
            ...
            child: Column(
              children: <Widget>[
                FadeAnimation(delay: 0.8,child: CachedNetworkImage(imageUrl: "https://media-exp1.licdn.com/dms/image/C4D22AQG4S08wP3tUTw/feedshare-shrink_800/0/1623069208078?e=1648684800&v=beta&t=hHTmPnIDbgA34YiPqPoU4gwJ4OnyUbcSsaGe9xTqDjs",width: we * 0.9,height: he * 0.4,),),
                SizedBox(
                  height: he * 0.01,
                ),
                FadeAnimation(
                  ...
                  child: Container(
                    ...
                    child: Text("",style: GoogleFonts.heebo(
                        color: Colors.grey,
                        letterSpacing: 0.5
                    ),
                    ),
                ...
                FadeAnimation(
                  ...
                  child: TextButton(
                      onPressed: (){},
                      child: Text("Giris Yap",style: GoogleFonts.heebo(
                          color: Colors.black,
                          letterSpacing: 0.5,
                        fontSize: 20.0,
                ...
                FadeAnimation(
                  delay: 1,
                  child: Text("sifremi unuttum",style: GoogleFonts.heebo(
                    color:  Color.fromARGB(255, 245, 79, 13).withOpacity(0.9),
                    letterSpacing: 0.5,
                  )),
                ),
                SizedBox(
